...
const RacingCenter = () => {
  const location = {
    ...
    staticMap:
      "https://maps.googleapis.com/maps/api/staticmap?center=701+S+Clinton+St+Suite+709,Fort+Wayne,IN+46802&zoom=15&size=400x200&markers=color:red%7C701+S+Clinton+St+Suite+709,Fort+Wayne,IN+46802&key=AIzaSyD591OKuUaezgbZ-hT34ewtY6OW2NiFwcg"
  };
